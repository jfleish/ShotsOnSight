...
// Complete rosters from official team websites
export const FULL_ROSTERS = {
  home: [
    ...
    // Running Backs
    { name: 'Kenneth Walker III', position: 'RB', number: '9' },
    ...
    { name: 'Rashid Shaheed', position: 'WR', number: '22' },
    { name: 'Jake Bobo', position: 'WR', number: '19' },
    { name: 'Dareke Young', position: 'WR', number: '83' },
    ...
    { name: 'Olu Oluwatimi', position: 'C', number: '55' },
    ...
    // Defensive Line
    { name: 'Leonard Williams', position: 'DT', number: '99' },
    { name: 'Byron Murphy II', position: 'DT', number: '91' },
    { name: 'Jarran Reed', position: 'NT', number: '90' },
    { name: 'Brandon Pili', position: 'NT', number: '95' },
    { name: 'Rylie Mills', position: 'DE', number: '98' },
    { name: 'Mike Morris', position: 'DE', number: '94' },
    // Linebackers
    { name: 'Boye Mafe', position: 'LB', number: '53' },
    { name: 'Uchenna Nwosu', position: 'LB', number: '7' },
    { name: 'Ernest Jones IV', position: 'LB', number: '13' },
    { name: 'Derick Hall', position: 'LB', number: '58' },
    { name: 'DeMarcus Lawrence', position: 'LB', number: '0' },
    ...
    { name: 'Riq Woolen', position: 'CB', number: '27' },
    { name: 'Josh Jobe', position: 'CB', number: '29' },
    { name: 'Nehemiah Pritchett', position: 'CB', number: '28' },
    // Safeties
    { name: 'Julian Love', position: 'S', number: '20' },
    { name: 'Coby Bryant', position: 'S', number: '8' },
    { name: 'Nick Emmanwori', position: 'S', number: '3' },
    { name: 'Ty Okada', position: 'S', number: '39' },
    { name: 'Quandre Diggs', position: 'S', number: '37' },
    { name: 'AJ Finley', position: 'S', number: '30' },
    // Special Teams
    { name: 'Jason Myers', position: 'K', number: '5' },
    { name: 'Michael Dickson', position: 'P', number: '4' },
    { name: 'Chris Stoll', position: 'LS', number: '41' },
  ],
  away: [
    // Quarterbacks
    { name: 'Drake Maye', position: 'QB', number: '10' },
    { name: 'Tommy DeVito', position: 'QB', number: '16' },
    { name: 'Joshua Dobbs', position: 'QB', number: '11' },
    // Running Backs
    { name: 'Rhamondre Stevenson', position: 'RB', number: '38' },
    { name: 'TreVeyon Henderson', position: 'RB', number: '32' },
    { name: 'Antonio Gibson', position: 'RB', number: '4' },
    ...
    // Wide Receivers
    { name: 'Stefon Diggs', position: 'WR', number: '8' },
    { name: 'DeMario Douglas', position: 'WR', number: '3' },
    { name: 'Kayshon Boutte', position: 'WR', number: '9' },
    { name: 'Mack Hollins', position: 'WR', number: '13' },
    { name: 'Kyle Williams', position: 'WR', number: '18' },
    { name: 'Efton Chism III', position: 'WR', number: '86' },
    // Tight Ends
    { name: 'Hunter Henry', position: 'TE', number: '85' },
    { name: 'Austin Hooper', position: 'TE', number: '81' },
    { name: 'CJ Dippre', position: 'TE', number: '82' },
    // Offensive Line
    { name: 'Mike Onwenu', position: 'OL', number: '71' },
    { name: 'Morgan Moses', position: 'OT', number: '76' },
    ...
    { name: 'Garrett Bradbury', position: 'C', number: '65' },
    { name: 'Ben Brown', position: 'C', number: '77' },
    { name: 'Jared Wilson', position: 'OL', number: '58' },
    { name: 'Yasir Durant', position: 'T', number: '72' },
    // Defensive Line
    { name: 'Christian Barmore', position: 'DT', number: '90' },
    { name: 'Milton Williams', position: 'DT', number: '97' },
    ...
    // Linebackers
    { name: 'Harold Landry III', position: 'LB', number: '2' },
    { name: 'Robert Spillane', position: 'LB', number: '14' },
    { name: 'Marte Mapu', position: 'LB', number: '15' },
    { name: 'Jahlani Tavai', position: 'LB', number: '48' },
    { name: "K'Lavon Chaisson", position: 'LB', number: '44' },
    { name: 'Anfernee Jennings', position: 'LB', number: '33' },
    ...
    // Cornerbacks
    { name: 'Christian Gonzalez', position: 'CB', number: '0' },
    { name: 'Carlton Davis III', position: 'CB', number: '7' },
    { name: 'Marcus Jones', position: 'CB', number: '25' },
    ...
    // Safeties
    { name: 'Jaylinn Hawkins', position: 'S', number: '21' },
    ...
    { name: 'Bryce Baringer', position: 'P', number: '17' },
